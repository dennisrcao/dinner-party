...
const InfoParkingSection = () => {
  ...
  return (
    <div className={styles.infoParkingContainer}>
      ...
      • If you can make it, please RSVP below and fill out the form.<br/><br/>
      ...
      • List your neighborhood in the form, I will create a group chat to coordinate carpool <br/> <br/>
